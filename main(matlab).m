...
for j=1:2;
    ...
    Nimage=SegmentImage(masked,step);%change to binary pic
    % 
...
%function generated by APP "Color Threshold"
function [BW,maskedRGBImage] = CreateMaskForTable(RGB)
...
%function generated by APP "Image Segmenter"
